...
def main():
    ...
    sampling = "uniform"      # or "priority" or "uniform_training"
    ...
    training_stream = DecayingHistogramStream(bins=num_bins, range=hist_range, decay_batch=10_000, decay_rate=0.99)
    ...
    for start_step, end_step in pairwise([0] + episode_steps):
        ...
        match sampling:
            ...
            case "uniform_training":
                # UniformTraining sampling
